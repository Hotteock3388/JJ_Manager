...
import com.depotato.presentation.ui.modify_equipment.add_equipment.AddEquipmentComposeActivity
import com.depotato.presentation.ui.text.notoSansFamily
import com.depotato.presentation.ui.theme.Black
import com.depotato.presentation.ui.theme.LogOut
...
fun MyPageScreen(
    ...
    Column(
        ...
        Column(
            ...
            MyPageMenuItem(
                textResourceId = R.string.menu_logout,
                textColor = LogOut,
